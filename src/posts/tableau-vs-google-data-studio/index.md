...
![](https://cdn-images-1.medium.com/max/1000/0*bkdacKHoWfpbMbgE.)
...
**Tool v/s solution**: Do you want a tool to help your team quickly build
dashboards (GDS), or are you looking for an end-to-end marketing data solution
(Tableau)?

**Channels**: What ad channels do you use? If it is largely Google ecosystem
...
**Resources**: How much of an investment (money and time!) are you willing to
